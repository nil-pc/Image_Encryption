...
void encrOpt(string pwd, string path){
  ...
  writeImg("Encr_Image.png",res[0],res[1],res[2]);
}

void decrOpt(string pwd, string path){
  ...
  writeImg("Decr_Image.png",newres[0],newres[1],newres[2]);
}
...
int main() {
  ...
  encrOpt(enc_pwd, srcImg);
  
  cout <<"Enter decr pwd: ";
  cin>>dec_pwd;
  decrOpt(dec_pwd, "Encr_Image.png");
